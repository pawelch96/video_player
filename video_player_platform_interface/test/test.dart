...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi api) {
    ...
    {
      const BasicMessageChannel<Object> channel =
          BasicMessageChannel<Object>('dev.flutter.pigeon.VideoPlayerApi.setPictureInPicture', StandardMessageCodec());
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.setPictureInPicture was null. Expected PictureInPictureMessage.');
          final PictureInPictureMessage input = PictureInPictureMessage.decode(message);
          api.setPictureInPicture(input);
          return <Object, Object>{};
        });
      }
    }
